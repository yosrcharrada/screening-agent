...
# InterviewSession Admin
@admin.register(InterviewSession)
class InterviewSessionAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'created_at', 'cv_preview', 'jd_preview']
...
class SkillMatchResultAdmin(admin.ModelAdmin):
    list_display = ['id', 'session', 'match_percentage', 'cv_skill_count', 'jd_skill_count', 'created_at']
    ...
    def get_session_user(self, obj):
        return obj.session.user.email if obj.session.user else 'No User'
    get_session_user.short_description = 'User'

# QuestionSet Admin - FIXED: No created_at field in QuestionSet
@admin.register(QuestionSet)
class QuestionSetAdmin(admin.ModelAdmin):
    list_display = ['id', 'session', 'questions_count']
    search_fields = ['session__user__email', 'session__id']
    list_select_related = ['session__user']
...
class TranscriptAdmin(admin.ModelAdmin):
    list_display = ['id', 'session', 'filler_words', 'wpm', 'text_preview', 'created_at']
    list_filter = ['created_at']
...
class ScoreResultAdmin(admin.ModelAdmin):
    list_display = ['id', 'session', 'overall_score', 'content_score', 'delivery_score', 'communication_score', 'created_at']
    list_filter = ['created_at']
    search_fields = ['session__user__email', 'session__id']
    readonly_fields = ['created_at']
    list_select_related = ['session__user']
